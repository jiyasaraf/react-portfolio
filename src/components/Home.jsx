...
const HeroSection = () => {
    ...
    return (
        ...
        >
            ...
            <div className="container mx-auto px-4 z-10 text-center relative max-w-4xl flex flex-col flex-1 justify-center">
...
export default function Home() {
    return (
        // Added scroll-smooth for smooth behavior across the entire page
